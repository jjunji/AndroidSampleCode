...
/*    public SmsHistoryLoader(Context context, List<ContactData> searchDatas) {
    ...
    public SmsHistoryLoader(Context context, HashMap<String, String> map) {
        this.context = context;
        this.map = map;
    }
...
/*                switch (checkType){
    ...
    public String getMachName2(String phoneNumber){
        String name = "";

        name = map.get(phoneNumber);
