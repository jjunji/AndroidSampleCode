...
import com.example.test.CallHistory.CallHistoryViewHolder;
...
public class SmsHistoryAdapter extends BaseAdapter{
    ...
    ArrayList<SmsHistoryData> datas = new ArrayList<>();
    Context context;

    public SmsHistoryAdapter(ArrayList<SmsHistoryData> datas, Context context) {
        this.datas = datas;
    ...
    @Override
    public SmsHistoryData getItem(int position) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        final SmsHistoryViewHolder viewHolder;

        if(convertView == null){
            viewHolder = new SmsHistoryViewHolder();

            LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            convertView = inflater.inflate(R.layout.item_sms_history, null);
            ...
            viewHolder = (SmsHistoryViewHolder) convertView.getTag();
        }
